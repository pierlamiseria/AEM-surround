...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 210.0, 100.0, 76.0, 20.0 ],
					"text" : "delay 150"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 45.0, 85.0, 83.0, 20.0 ],
					"text" : "delay 2700"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 4,
					"outlettype" : [ "bang", "sourcesT.xml", "bang", "bang" ],
					"patching_rect" : [ 45.0, 35.0, 155.0, 20.0 ],
					"text" : "t b sourcesT.xml b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 145.0, 97.0, 20.0 ],
					"text" : "prepend read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 125.0, 158.0, 18.0 ],
