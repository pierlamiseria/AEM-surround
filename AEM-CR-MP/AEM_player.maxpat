...
,
		"openrect" : [ 667.0, 44.0, 212.0, 410.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 315.0, 68.0, 20.0 ],
					"text" : "pack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 555.0, 360.0, 117.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 135.0, 180.0, 17.0 ],
					"text" : "1min 29sec",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.0, 385.0, 83.0, 20.0 ],
					"text" : "pack 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 450.0, 430.0, 115.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 125.0, 180.0, 17.0 ],
					"text" : "24bit 96000KHz 4ch",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 645.0, 250.0, 115.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 115.0, 180.0, 17.0 ],
					"text" : "Motorbike_W_LRCS.wav",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 645.0, 230.0, 54.0, 18.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 145.0, 97.0, 20.0 ],
					"text" : "prepend open"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 405.0, 200.0, 256.0, 21.0 ],
					"text" : "sfinfo~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.0, 120.0, 83.0, 20.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 255.0, 345.0, 76.0, 32.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 180.0, 345.0, 71.0, 32.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 345.0, 30.0, 48.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 150.0, 345.0, 30.0, 48.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 255.0, 315.0, 39.0, 20.0 ],
					"text" : "% 60"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 180.0, 315.0, 39.0, 20.0 ],
					"text" : "/ 60"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 180.0, 260.0, 104.0, 20.0 ],
					"text" : "snapshot~ 100"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.0, 80.0, 100.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 200.0, 210.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 180.0, 150.0, 100.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 30.0, 260.0, 101.0, 255.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 54.5, 145.0, 101.0, 205.0 ],
